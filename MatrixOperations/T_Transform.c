/*
Appliquer la transformation t avec parametre delta passe en parametre
sur un matrice en Rii
V1.0 22/10/10
...
void  usage()
{
	printf("usage : T_Transform -f filename delta \n");
	printf("filename.sz and filename.Rii must exist\n");
	printf("Apply the t-tansform \n");
	exit(1);
}

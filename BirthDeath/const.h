...
#define DEBUG    0       // 1 pour la version debug + calcul de certaines rewards, génére fichier "MMBC_Queue.pi"
                         // 0 pour la version non-debug, génére fichier "MMBC_Queue.pi"